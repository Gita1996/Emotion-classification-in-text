# -*- coding: utf-8 -*-
"""attention_visualization_summary2_isear_emotion_prompt_Deberta.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Hz-Vs8CRi4M7L2X9JMMCRzjHQetJDN3s
"""
...
def analyze_token_alignment(premise, emotion):
    ...
    inputs_without_template = tokenizer.encode_plus(premise, f"The emotion is {emotion}", return_tensors='pt')
...
data_file='ISEAR-nli-prompt-expr_emo3-Deberta3.csv'
data_file='ISEAR-nli-prompt-emotion3-deberta2.csv'
...
df.to_csv('attention_visualization_summary2_isear_emotion_prompt_deberta.csv')